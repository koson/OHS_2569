...
1️การกำหนดมาตรการตัดโดมิโนตัวที่ 3
ในการกำจัด Unsafe Act จะกำหนดให้คนงานทุกคนที่ต้องปฏิบัติงานบนที่สูงหรือใกล้แนวไฟฟ้าแรงสูงต้องผ่านการอบรมและทดสอบความรู้เรื่องระยะห่างปลอดภัยจากไฟฟ้าก่อนได้รับอนุญาตให้เข้าทำงานทุกครั้ง พร้อมทั้งบังคับใช้ระบบขออนุญาตทำงาน (Work Permit) ที่ต้องมีการเซ็นรับทราบความเสี่ยงก่อนเริ่มงานทุกครั้ง ส่วนการกำจัด Unsafe Condition จะจัดให้มีการสำรวจพื้นที่ปฏิบัติงานล่วงหน้าทุกครั้งก่อนมอบหมายงาน หากพบว่ามีแนวสายไฟฟ้าแรงสูงอยู่ในระยะเสี่ยง ต้องประสานการไฟฟ้าให้ตัดกระแสไฟชั่วคราวหรือติดตั้งฉนวนกันไฟก่อนอนุญาตให้เริ่มงานเด็ดขาด

2️การออกแบบแนวป้องกัน 4 ชั้นตาม Swiss Cheese Model
ด่านที่หนึ่งด้านนโยบายและกฎระเบียบ จะออกนโยบายบังคับให้ทุกงานที่เกี่ยวข้องกับที่สูงหรือไฟฟ้าแรงสูงต้องผ่านการประเมินความเสี่ยงหน้างาน (JSA) และขออนุญาตทำงานเป็นลายลักษณ์อักษรก่อนเริ่มงานทุกครั้งโดยไม่มีข้อยกเว้น ด่านที่สองด้านระบบวิศวกรรม จะติดตั้งระบบแจ้งเตือนระยะใกล้ไฟฟ้าแรงสูง (Proximity Alarm) หรือประสานตัดกระแสไฟฟ้าเป็นการชั่วคราวในจุดที่ต้องปฏิบัติงานใกล้แนวสายไฟ พร้อมติดตั้งแนวกั้นเขตอันตรายที่ชัดเจน ด่านที่สามด้าน SOP และการอบรม จะจัดทำคู่มือขั้นตอนการทำงานบนที่สูงใกล้ไฟฟ้าแรงสูงโดยเฉพาะ ติดป้ายเตือนระยะห่างปลอดภัยในจุดที่มีความเสี่ยงทุกจุด และจัดอบรมทบทวนความปลอดภัยให้พนักงานทุกคนอย่างน้อยปีละครั้ง ด่านที่สี่ด้านอุปกรณ์ป้องกันส่วนบุคคล จะจัดหาชุดเซฟตี้ฮาร์เนสมาตรฐานสำหรับงานที่สูง ถุงมือและรองเท้ากันกระแสไฟฟ้า พร้อมทั้งกำหนดให้หัวหน้างานตรวจสอบสภาพอุปกรณ์ก่อนเริ่มงานทุกครั้งโดยไม่มีการผ่อนผัน

3️การส่งเสริม Near Miss และบทพูดสร้างแรงจูงใจลูกน้อง
สำหรับมาตรการส่งเสริมการแจ้งเหตุ Near Miss จะสร้างระบบแจ้งเหตุแบบไม่เปิดเผยชื่อผู้แจ้งและยืนยันชัดเจนว่าจะไม่มีการลงโทษผู้ที่รายงานเหตุการณ์เกือบเกิดอุบัติเหตุ พร้อมทั้งจัดให้มีรางวัลหรือคำชมเชยสำหรับผู้ที่กล้ารายงาน เพื่อปรับทัศนคติจาก "การแจ้งเหตุคือการเปิดโปงความผิด" ให้กลายเป็น "การแจ้งเหตุคือการช่วยเพื่อนร่วมงานให้ปลอดภัย"
บทพูดปลุกใจก่อนเริ่มงานกะเช้า: "ทุกคนครับ วันนี้ก่อนเริ่มงาน ขอให้ทุกคนตรวจเช็คอุปกรณ์ป้องกันตัวเองให้พร้อมทุกชิ้น เพราะที่บ้านมีคนรอเราอยู่ ไม่มีงานไหนสำคัญไปกว่าชีวิตของเรา ถ้าเจออะไรที่รู้สึกไม่ชอบมาพากลหรือเสี่ยงอันตราย ให้หยุดและแจ้งทันทีโดยไม่ต้องกลัวถูกตำหนิ เพราะเราอยากเห็นทุกคนสวมใส่ PPE ครบทุกวัน แล้วกลับบ้านไปหาครอบครัวอย่างปลอดภัยทุกคืน"
