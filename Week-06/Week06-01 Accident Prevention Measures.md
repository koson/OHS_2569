...
---
ไม่มีตัวเลขงบประมาณเฉพาะเจาะจง ที่รัฐบาลไทยเปิดเผยว่า "ใช้เงินเท่าไหร่ในการร่าง พ.ร.บ. ความปลอดภัยฯ 2554" หรือ "พ.ร.บ. จราจร" เพราะกระบวนการร่างกฎหมายในไทยเป็นส่วนหนึ่งของงบประมาณดำเนินงานปกติของกระทรวง/กรม (เงินเดือนข้าราชการ ค่าจัดประชุมรับฟังความเห็น ค่าเดินทาง) ไม่ได้แยกบัญชีเป็นก้อนเฉพาะแบบโครงการก่อสร้าง เลยไม่มีเลขตัวเดียวให้หยิบมาเทียบตรงๆ

แต่ทำการบ้านให้แบบใช้ข้อมูลที่มีจริงเทียบเชิงแนวคิดได้ ดังนี้:

แนวทางที่ 1: เทียบ พ.ร.บ. ความปลอดภัยฯ 2554 กับ PPE

พ.ร.บ. ความปลอดภัย อาชีวอนามัย และสภาพแวดล้อมในการทำงาน พ.ศ. 2554 จัดตั้งกองทุนความปลอดภัย อาชีวอนามัย และสภาพแวดล้อมในการทำงานขึ้นในกรมสวัสดิการและคุ้มครองแรงงาน — กองทุนนี้มีงบดำเนินงาน/ให้กู้ยืมแก่สถานประกอบการปีละหลายสิบล้านบาท (ตัวเลขเปลี่ยนแปลงทุกปี ต้องดูรายงานประจำปีของกองทุนที่ oshfund.go.th) 
Fti
Sut
เทียบกับ: PPE พื้นฐาน 1 ชุด (หมวกนิรภัย + ถุงมือ + แว่นตานิรภัย) ราคาประมาณ 300-1,500 บาทต่อคน

แนวทางที่ 2: พ.ร.บ. จราจร กับหมวกนิรภัย
งบประมาณร่างกฎหมายจราจรไม่เปิดเผยแยกเฉพาะเช่นกัน แต่เทียบเชิงผลลัพธ์ได้ง่ายกว่า: หมวกกันน็อคราคา 300-2,000 บาท ลดความเสี่ยงเสียชีวิตจากอุบัติเหตุมอไซค์ได้มาก ขณะที่ค่ารักษาพยาบาลอาการบาดเจ็บที่ศีรษะรุนแรง 1 เคสอาจสูงหลักแสนถึงล้านบาท

แนะนำให้เขียนในรายงานแบบนี้แทน (เพราะข้อมูลจริงหาไม่ได้):

ระบุตรงๆ ว่างบประมาณร่างกฎหมายไม่ถูกเปิดเผยแยกเฉพาะ เป็นส่วนหนึ่งของงบราชการประจำ
เปลี่ยนมุมเทียบเป็น "ต้นทุนป้องกัน" vs "ต้นทุนความเสียหายเมื่อไม่มีกฎหมาย/ไม่ปฏิบัติตาม" แทน เช่น ค่า PPE ต่อคนต่อปี เทียบกับค่าใช้จ่ายรักษา+ชดเชยเมื่อเกิดอุบัติเหตุ 1 ครั้ง (ใช้ตัวเลขจากส่วนที่ 4 ที่ทำไปแล้ว: 500,000 ทางตรง + 1,500,000 ทางอ้อม)
สรุปว่ากฎหมายเป็นแค่ "กรอบ" แต่การลงทุนจริงที่ป้องกันได้คือ PPE/ระบบวิศวกรรมหน้างาน ซึ่งถูกกว่าความเสียหายมาก
