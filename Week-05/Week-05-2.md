...
ข้อที่ 1: ทฤษฎีโดมิโนของไฮน์ริช (Heinrich's Domino Theory)
หากมองย้อนไปตามลำดับเหตุการณ์ โดมิโนตัวที่หนึ่งซึ่งเป็นภูมิหลังและสิ่งแวดล้อม คือการที่คนงานเป็นแรงงานต่างด้าวที่อาจไม่ได้ผ่านการอบรมความปลอดภัยในการทำงานบนที่สูงหรือทำงานใกล้ไฟฟ้าแรงสูงอย่างเป็นระบบ ประกอบกับวัฒนธรรมการทำงานแบบเร่งรีบที่ให้ความสำคัญกับความเร็วมากกว่าการประเมินความเสี่ยงก่อนเริ่มงาน โดมิโนตัวที่สองคือความบกพร่องของบุคคล ซึ่งในที่นี้คือการที่คนงานอาจไม่ตระหนักถึงระยะห่างปลอดภัยที่ต้องเว้นจากแนวสายไฟฟ้าแรงสูง หรือประเมินระยะทางผิดพลาดขณะไต่เชือกลงมา โดมิโนตัวที่สามคือสาเหตุโดยตรง ซึ่งเป็นทั้ง Unsafe Act คือการไต่เชือกเข้าใกล้แนวสายไฟโดยไม่มีการวัดระยะปลอดภัยหรือขอตัดกระแสไฟก่อน และ Unsafe Condition คือการที่พื้นที่ปฏิบัติงานมีสายไฟฟ้าแรงสูงพาดผ่านอยู่ใกล้จุดทำงานโดยไม่มีการป้องกันหรือแนวเขตกันชนที่ชัดเจน โดมิโนตัวที่สี่คืออุบัติเหตุที่เกิดขึ้นจริง คือขณะไต่เชือกลงมา ร่างกายส่วนหลังไปสัมผัสสายไฟฟ้าแรงสูงจนถูกกระแสไฟฟ้าดูด และโดมิโนตัวที่ห้าคือความสูญเสีย ซึ่งคือการเสียชีวิตของคนงานจากไฟฟ้าดูดร่วมกับการตกจากที่สูง
บทคำเตือนทะลุมิติย้อนเวลา: หากย้อนเวลากลับไปได้ จะพูดเตือนเขาว่า "พี่ครับ ก่อนจะไต่เชือกลงไปทำงานตรงนั้น ต้องหยุดดูก่อนว่ามีสายไฟแรงสูงอยู่ใกล้แค่ไหน ถ้าใกล้เกินไปให้แจ้งหัวหน้างานให้ประสานการไฟฟ้ามาตัดไฟหรือกั้นแนวก่อน อย่าเสี่ยงแม้จะดูเหมือนใกล้จะเสร็จงานแล้วก็ตาม" เพื่อหยุดยั้งไม่ให้โดมิโนตัวที่สี่และห้าล้มลง

ข้อที่ 2: ทฤษฎีโดมิโนดัดแปลงของเบิร์ดและลอฟตัส (Bird & Loftus)
ขั้นที่หนึ่งคือการขาดการควบคุมของฝ่ายบริหาร ซึ่งสะท้อนจากการที่บริษัทผู้ว่าจ้างอาจไม่มีการประเมินความเสี่ยงหน้างาน (Job Safety Analysis) ก่อนมอบหมายงานทำความสะอาดในพื้นที่ที่มีแนวไฟฟ้าแรงสูง และไม่มีระบบตรวจสอบว่าพื้นที่ปฏิบัติงานปลอดภัยเพียงพอหรือไม่ก่อนปล่อยให้คนงานเริ่มงาน ขั้นที่สองคือสาเหตุพื้นฐาน ทั้งด้านปัจจัยคนคือคนงานขาดความรู้เรื่องระยะปลอดภัยจากไฟฟ้าแรงสูง และปัจจัยงานคือไม่มีการวางแผนเส้นทางการไต่เชือกที่หลีกเลี่ยงแนวสายไฟฟ้าตั้งแต่ต้น ขั้นที่สามคือสาเหตุทางตรงซึ่งซ้ำกับ Unsafe Act และ Unsafe Condition ที่กล่าวมาข้างต้น ขั้นที่สี่คืออุบัติการณ์การสัมผัสอันตราย คือร่างกายสัมผัสกับกระแสไฟฟ้าแรงสูงโดยตรง และขั้นที่ห้าคือความสูญเสีย ซึ่งไม่เพียงชีวิตของคนงานเท่านั้น แต่ยังรวมถึงความสูญเสียทางธุรกิจของนายจ้างจากการหยุดงานเพื่อสอบสวนเหตุ ความรับผิดทางกฎหมาย และภาพลักษณ์องค์กร
บทคำเตือนทะลุมิติย้อนเวลา: หากย้อนเวลากลับไปบอกผู้บริหารหรือหัวหน้างานได้ จะพูดว่า "ก่อนจ้างงานทำความสะอาดในพื้นที่นี้ ต้องสำรวจหน้างานและประสานการไฟฟ้าขอตัดกระแสไฟหรือกั้นแนวป้องกันก่อนเสมอ อย่าปล่อยให้คนงานเข้าไปทำงานใกล้สายไฟแรงสูงโดยไม่มีการประเมินความเสี่ยงล่วงหน้า เพราะชีวิตคนสำคัญกว่าความเร็วของงาน" เพื่อให้เกิดการวางระบบและควบคุมความเสี่ยงตั้งแต่ต้นทาง

ข้อที่ 3: โมเดลเนยแข็งสวิสของรีซัน (Swiss Cheese Model)
ด่านที่หนึ่งคือนโยบายและกฎระเบียบ ซึ่งรูรั่วแฝงคือการที่ผู้ว่าจ้างอาจไม่มีนโยบายบังคับให้ประเมินความเสี่ยงพื้นที่ทำงาน (Risk Assessment) ก่อนมอบหมายงานที่เกี่ยวข้องกับความสูงและไฟฟ้าแรงสูงอย่างเป็นลายลักษณ์อักษร ด่านที่สองคือระบบวิศวกรรมและเซฟตี้ รูรั่วคือไม่มีการติดตั้งแนวป้องกันหรือฉนวนกันไฟฟ้ารั่วในบริเวณที่มีสายไฟฟ้าแรงสูงใกล้พื้นที่ที่มีคนทำงาน และไม่มีการประสานการไฟฟ้าให้ตัดกระแสชั่วคราวระหว่างทำงาน ด่านที่สามคือขั้นตอนปฏิบัติงานและป้ายเตือน รูรั่วคือไม่มี SOP หรือป้ายเตือนระยะห่างปลอดภัยจากไฟฟ้าแรงสูงในจุดปฏิบัติงานจริง และด่านที่สี่คืออุปกรณ์ป้องกันส่วนบุคคล รูรั่วคือคนงานไม่ได้สวมใส่อุปกรณ์ตรวจจับกระแสไฟฟ้าหรืออุปกรณ์ป้องกันไฟฟ้าดูดขณะทำงานใกล้แนวไฟฟ้าแรงสูง
จุดที่รูเนยทั้งสี่ด่านตรงกันคือ เมื่อไม่มีนโยบายบังคับประเมินความเสี่ยงตั้งแต่ต้น ไม่มีระบบตัดไฟหรือกั้นแนวป้องกัน ไม่มีป้ายเตือนหรือ SOP หน้างาน และคนงานไม่มีอุปกรณ์ป้องกันภัยที่เหมาะสม ทำให้ไม่มีด่านใดเลยที่สามารถสกัดกั้นอันตรายไว้ได้ อันตรายจึงทะลุผ่านทุกชั้นจนเกิดโศกนาฏกรรมในที่สุด
บทคำเตือนทะลุมิติย้อนเวลา: หากย้อนเวลากลับไปอุดรูรั่วเนยแข็งได้ จะพูดเตือนว่า "ก่อนเริ่มงานทุกครั้งที่ต้องทำงานใกล้สายไฟฟ้าแรงสูง ต้องมีการประสานตัดไฟหรือกั้นแนวเขตปลอดภัยเป็นลายลักษณ์อักษรก่อนเสมอ และคนงานทุกคนต้องได้รับการอบรมเรื่องระยะห่างปลอดภัยจากไฟฟ้าแรงสูงก่อนเริ่มปฏิบัติงานจริง" เพื่ออุดรูรั่วในด่านที่หนึ่งและด่านที่สอง ไม่ให้อันตรายทะลุผ่านไปถึงตัวคนงานได้
