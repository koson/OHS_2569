...
>
> สรุปเนื้อหา Week 05: พื้นฐานการป้องกันอุบัติเหตุ

สัปดาห์นี้ได้เรียนรู้ว่าอุบัติเหตุไม่ได้เกิดขึ้นจากโชคหรือความบังเอิญเพียงอย่างเดียว แต่มีสาเหตุที่สามารถวิเคราะห์และป้องกันได้

อุบัติเหตุสามารถป้องกันได้
การป้องกันตั้งแต่ก่อนเกิดเหตุช่วยลดการบาดเจ็บ ความเสียหาย และค่าใช้จ่ายที่อาจเกิดขึ้นในภายหลัง
การตัดโดมิโนตัวที่ 3
ตามทฤษฎีของ Heinrich เราสามารถป้องกันอุบัติเหตุได้โดยกำจัด Unsafe Act และ Unsafe Condition เช่น ไม่ทำพฤติกรรมเสี่ยงและแก้ไขสภาพแวดล้อมที่ไม่ปลอดภัย
การแก้ปัญหาที่ระบบ ไม่ใช่โทษคนเพียงอย่างเดียว
ทฤษฎี Bird & Loftus และ Swiss Cheese Model เน้นการสร้างระบบความปลอดภัยหลายชั้น และแก้ไขช่องโหว่ที่อาจทำให้เกิดอุบัติเหตุ
ความสูญเสียไม่ได้มีแค่สิ่งที่มองเห็น
ตาม Iceberg Model ค่าใช้จ่ายจากอุบัติเหตุมีทั้งต้นทุนทางตรง เช่น ค่ารักษาพยาบาล และต้นทุนทางอ้อม เช่น ค่าเสียเวลา การหยุดงาน ขวัญกำลังใจ และค่าใช้จ่ายอื่น ๆ ซึ่งต้นทุนทางอ้อมอาจสูงกว่าต้นทุนทางตรงหลายเท่า
ควรส่งเสริมการรายงาน Near Miss
การสร้างวัฒนธรรมที่ไม่มุ่งโทษบุคคลจะทำให้คนกล้าแจ้งเหตุการณ์เกือบเกิดอุบัติเหตุ และสามารถนำข้อมูลไปแก้ไขก่อนที่จะเกิดอุบัติเหตุรุนแรง
สรุปความคิดเห็น

สิ่งที่ได้จากบทเรียนนี้คือ การป้องกันอุบัติเหตุควรเริ่มตั้งแต่ก่อนเกิดเหตุ ไม่ควรรอให้เกิดอุบัติเหตุแล้วค่อยแก้ไข ทุกคนควรช่วยกันสังเกตพฤติกรรมและสภาพแวดล้อมที่ไม่ปลอดภัย รวมถึงกล้าที่จะแจ้ง Near Miss เพื่อป้องกันไม่ให้เกิดเหตุรุนแรงในอนาคต เพราะความปลอดภัยไม่ได้ขึ้นอยู่กับอุปกรณ์เพียงอย่างเดียว แต่ขึ้นอยู่กับความตระหนักและความใส่ใจของทุกคนด้วย
