...
### 1. การจำแนกต้นทุนทางตรง (Direct Costs / Insured Costs - ส่วนลอยพ้นน้ำ)
* **รายการค่าใช้จ่าย:** ค่ารักษาพยาบาลคนงานเจ็บสาหัส, ค่าจัดการศพและเงินชดเชยตามกฎหมายให้ครอบครัวผู้เสียชีวิต, ค่าซ่อมแซมโครงสร้างเหล็กและอุปกรณ์ที่เสียหาย
* **ประมาณการจำนวนเงินเบื้องต้น:** 500,000 บาท

---

### 2. การจำแนกต้นทุนทางอ้อม (Indirect Costs / Uninsured Costs - ส่วนจมใต้น้ำ)
* **รายการค่าใช้จ่ายแอบแฝง:**
  1. ค่าเสียเวลาหยุดงานและ Downtime ในการถูกสั่งระงับไซต์งานเพื่อสอบสวนคดี
  2. ค่าเสียโอกาสและค่าปรับจากการส่งมอบงานก่อสร้างล่าช้ากว่าสัญญา
  3. ค่าทำงานล่วงเวลา (OT) และค่าจัดหา/ฝึกอบรมแรงงานคนใหม่มาแทน
  4. ค่าเบี้ยประกันภัยความรับผิดชอบที่ปรับตัวสูงขึ้นในปีถัดไป
* **ประมาณการจำนวนเงินแอบแฝง:** 2,500,000 บาท

---

### 3. การเปรียบเทียบอัตราส่วนและการโน้มน้าวฝ่ายบริหาร (Management Pitching)
* **อัตราส่วนประเมิน:** ต้นทุนทางตรง : ต้นทุนทางอ้อม = 1 : 5
* **กลยุทธ์โน้มน้าวผู้บริหาร:** 
  จากเหตุการณ์นี้ ต้นทุนทางตรง 5 แสนบาทที่ประกันจ่ายเป็นเพียงแค่ยอดภูเขาน้ำแข็ง แต่บริษัทต้องจ่ายเงินจมใต้น้ำสูงถึง 2.5 ล้านบาทจากค่าเสียเวลา ค่าปรับงานล่าช้า และค่าจัดหาคนใหม่
  หากเราอนุมัติงบประมาณความปลอดภัยเพียง 1-2 แสนบาทเพื่อติดตั้งอุปกรณ์ค้ำยันชั่วคราวและจัดอบรมความปลอดภัยหน้างานอย่างเข้มงวด จะช่วยป้องกันไม่ให้บริษัทต้องสูญเสียเงินล้านที่ประกันไม่คุ้มครอง
  การลงทุนป้องกันก่อนเกิดเหตุจึงเป็นแนวทางที่คุ้มค่าสูงสุดสำหรับบริษัท และช่วยคุ้มครองทั้งเงินทุน ชื่อเสียง รวมถึงชีวิตของพนักงานทุกคนในระยะยาวได้อย่างยั่งยืน
