...
สัปดาห์นี้ได้เรียนรู้ว่า อุบัติเหตุสามารถป้องกันได้ ถ้าเรารู้สาเหตุและแก้ไขก่อนที่จะเกิดเหตุจริง โดยใช้ทฤษฎีโดมิโนในการตัดวงจรอันตราย เช่น การกำจัดพฤติกรรมที่ไม่ปลอดภัยและสภาพแวดล้อมที่ไม่ปลอดภัย

นอกจากนี้ยังได้เรียนรู้ Swiss Cheese Model ที่เน้นการป้องกันหลายชั้น ไม่ควรพึ่งแค่มาตรการเดียว และควรแก้ไขปัญหาที่เกิดจากระบบด้วย

ส่วน Iceberg Model ทำให้เห็นว่าความเสียหายจากอุบัติเหตุไม่ได้มีแค่ค่ารักษาพยาบาลหรือค่าซ่อมแซม แต่ยังมีต้นทุนแฝง เช่น การหยุดงาน ค่าเสียเวลา และผลกระทบต่อชื่อเสียงขององค์กร

สุดท้ายคือการ รายงาน Near Miss โดยไม่มุ่งโทษคน เพื่อให้สามารถนำปัญหาไปแก้ไขก่อนที่จะเกิดอุบัติเหตุรุนแรง

ข้อคิด: ความปลอดภัยควรเริ่มจากความใส่ใจของทุกคน และควรป้องกันไว้ก่อนดีกว่ารอให้เกิดอุบัติเหตุแล้วค่อยแก้ไขครับ
